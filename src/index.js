...
app.get('/', (req, res) => {
  res.send('This bot is running DargoTamber\'s  <a href="https://github.com/hyperdargo/discordbot">Discord-Bot</a>')
})
...
console.log(`\u001b[0m`)
console.log(chalk.red(`© DargoTamber | 2021 - ${new Date().getFullYear()}`))
